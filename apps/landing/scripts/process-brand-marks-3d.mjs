...
const manifestPath = path.join(landingRoot, 'src/data/brand-marks-3d.ts');
...
function generateManifest(entries) {
  const lines = entries.map(
    (e) =>
      `  { slug: '${e.slug}', src: '${e.src}', tier: '${e.tier}', x: ${e.x}, y: ${e.y}, scale: ${e.scale}, floatPhase: ${e.floatPhase} },`,
  );

  return `/** Auto-generated by scripts/process-brand-marks-3d.mjs — do not edit manually. */
