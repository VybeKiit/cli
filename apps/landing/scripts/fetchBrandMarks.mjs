...
const SOURCES = {
  ...
  sonner: ['https://raw.githubusercontent.com/emilkowalski/sonner/main/website/public/og.png'],
  googlechrome: [
...
async function writeOpenAiKnot() {
  ...
  await writeWebp('openai', Buffer.from(svg));
  console.log('✓ openai.webp ← official OpenAI knot (white on transparent)');
}
