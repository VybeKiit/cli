  ...
  <section id="how-it-works" className="mx-auto max-w-5xl space-y-16 px-6 py-8">
    <div className="grid items-center gap-10 lg:grid-cols-2">
      <div>
        <p className="font-medium text-muted-foreground text-xs uppercase tracking-widest">
          {PROBLEM_OVERVIEW.problemLabel}
        </p>
        <h2 className="mt-3 font-bold text-3xl tracking-tight">
          {PROBLEM_OVERVIEW.problemHeading}
        </h2>
        <p className="mt-3 text-muted-foreground leading-relaxed">{PROBLEM_OVERVIEW.problemBody}</p>
      </div>

      <div className="overflow-hidden rounded-2xl border border-border/80 bg-card shadow-sm">
        <div className="flex items-center justify-between border-border/70 border-b bg-muted/30 px-5 py-3">
          <p className="font-semibold text-sm">{PROBLEM_OVERVIEW.overviewTitle}</p>
    ...
    <div className="grid items-center gap-10 lg:grid-cols-2">
      ...
      <div className="order-2 overflow-hidden rounded-2xl border border-border/80 bg-card shadow-sm lg:order-1">
        ...
        <div className="grid gap-0 sm:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-3 border-border/70 p-4 sm:border-e">
            <div>
              <p className="text-muted-foreground text-xs">{SOLUTION_PAYMENTS.revenueLabel}</p>
      ...
      <div className="order-1 lg:order-2">
        <p className="font-medium text-muted-foreground text-xs uppercase tracking-widest">
          {SOLUTION_PAYMENTS.solutionLabel}
        </p>
        <h2 className="mt-3 font-bold text-3xl tracking-tight">
          {SOLUTION_PAYMENTS.solutionHeading}
        </h2>
        <p className="mt-3 text-muted-foreground leading-relaxed">
          {SOLUTION_PAYMENTS.solutionBody}
        </p>
      </div>
    </div>
  </section>
