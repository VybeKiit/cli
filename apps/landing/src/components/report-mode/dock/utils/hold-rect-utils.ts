 ...
 * @example
 * const result = getRoundedRectPerimeter(width, height, radius);
 */

export const getRoundedRectPerimeter = (width: number, height: number, radius: number): number => {
 ...
 * @returns The computed result.
 * @example
 * const result = buildRoundedRectStrokePath(x, y, width, height, radius);
 */

export const buildRoundedRectStrokePath = (
  x: number,
  y: number,
  width: number,
  height: number,
