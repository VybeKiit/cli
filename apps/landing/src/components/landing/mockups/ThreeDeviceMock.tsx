  ...
  <div className="absolute top-[38px] left-[28px] h-[430px] w-[294px] rounded-[13px] border border-black/8 bg-white shadow-[0_18px_60px_rgba(15,23,42,0.14)]">
    <div className="flex items-center justify-between border-black/5 border-b px-5 py-4">
      <div className="flex items-center gap-2">
        ...
        <p className="font-bold text-sm text-[#0f172a]">Dashboard</p>
      </div>
      <span className="text-[#64748b] text-xs">⌄</span>
    </div>

    <div className="px-5 pt-4">
      <p className="font-semibold text-[#0f172a] text-sm">Welcome back, Alex.</p>
      <p className="mt-1 text-[#64748b] text-xs">Here&apos;s what&apos;s happening today.</p>

      <div className="mt-6">
        <div className="flex items-center justify-between">
          <p className="text-[#64748b] text-xs">Total Volume</p>
          <span className="text-xs text-emerald-600">+12.5%</span>
        </div>
        <p className="font-bold text-2xl text-[#0f172a] tracking-tight">$24,880</p>
      ...
      <div className="mt-5 grid grid-cols-2 gap-2">
        {['Invoice', 'Subscription', 'Payout', 'Refund'].map((label, index) => (
          <div className="rounded-lg border border-black/6 bg-[#f8fafc] px-3 py-2" key={label}>
            <div className="flex items-center justify-between">
              <p className="font-semibold text-[#0f172a] text-xs">{label}</p>
              <span className="text-xs text-[#94a3b8]">{index + 2}m ago</span>
            </div>
            <p className="mt-1 text-xs text-[#64748b]">$1,500</p>
  ...
  <MiniPhoneShell className="mini-iphone--flat absolute top-[52px] left-[318px] z-20 h-[460px] w-[214px] max-w-none">
    <div className="h-full px-3.5 pt-1 pb-1">
      <div className="mb-3 flex items-center justify-between">
        <p className="font-bold text-base text-white">Dashboard</p>
        <span className="text-white/55 text-xs">◎ ◎</span>
      </div>
      <p className="text-xs text-white/44">Total Volume</p>
      <p className="font-bold text-2xl text-white tracking-tight">$24,880</p>
      ...
      <div className="mt-4 rounded-xl border border-white/5 bg-white/[0.03] p-3">
        <p className="font-semibold text-xs text-white/80">Overview</p>
