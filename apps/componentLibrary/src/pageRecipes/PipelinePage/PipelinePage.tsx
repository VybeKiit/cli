...
export const PipelinePage = () => {
  ...
  return (
    <DemoRecipeFrame defaultTransition="slide" title="Pipeline motion pass">
        ...
        <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <PipelineStat
              ...
              label="Open value"
              value={formatUsdWholeCents(totals.value)}
            />
          </div>
        </div>
                ...
                <header className="flex items-center justify-between gap-2 px-3 py-3">
                  <div>
                    ...
                    <p className="text-muted-foreground text-xs">
                      {columnDeals.length} · {formatUsdWholeCents(columnValue)}
                    </p>
                  </div>
                ...
                <ul className="flex min-h-[120px] flex-1 flex-col gap-2 px-2 pb-3">
                  {columnDeals.length === 0 ? (
                    <li className="flex flex-1">
                      <Empty className="min-h-0 flex-1 bg-background/50 text-xs" variant="compact">
                        <EmptyHeader>
                          <EmptyDescription className="text-xs">Drop a deal here</EmptyDescription>
                        </EmptyHeader>
                      </Empty>
                    </li>
                  ) : (
