...
Live updates — chat, presence, live dashboards without polling.
...
Pub/sub channels adapter. Supabase Realtime default.
...
- **Do not edit** node_modules/@vybekiit/realtime — fix bugs upstream or bump the package version.
- **Entry point:** `resolveRealtimeProvider`, `RealtimeChannel`, `RealtimeHandler`
- **Config:** `REALTIME_PROVIDER` (default `supabase`)
- **Related skills:** Feature skills for live features
...
- Subscribe, publish, channel lifecycle.
