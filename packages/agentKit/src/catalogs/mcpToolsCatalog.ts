...
export const FIRST_PARTY_MCP_TOOLS: readonly McpToolCatalogEntry[] = [
  ...
  },
  {
    ...
    server: 'vybekiit',
    description:
      'Run vybekiit-automate from any project root (resolves bin). Always --json. Prefer dryRun first.',
    requiredParams: ['domain', 'command'],
    optionalParams: ['args', 'dryRun', 'yes', 'cdp', 'profile', 'timeoutMs'],
    whenToUse: 'Execute browser automations anywhere; dryRun=true to preview argv only.',
  },
  {
