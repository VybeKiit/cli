...
/** Tabs primitive re-export from the underlying UI library. */
const Tabs = TabsPrimitive.Root;

/**
 * Render the Tabs List component.
 *
...
/**
 * Render the Tabs Trigger component.
 *
 * @param props - Component props forwarded to the underlying UI primitive.
...
/**
 * Render the Tabs Content component.
 *
 * @param props - Component props forwarded to the underlying UI primitive.
