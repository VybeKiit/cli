...
See who visits your app — privacy-friendly stats by default.
...
Visitor analytics adapter. Plausible default; PostHog when you want funnels and events.
...
- **Do not edit** node_modules/@vybekiit/analytics — fix bugs upstream or bump the package version.
- **Entry point:** `resolveAnalyticsProvider`, `TrackEvent`, `ScriptConfig`
- **Config:** `ANALYTICS_PROVIDER` (default `plausible`), `PLAUSIBLE_DOMAIN`
- **Related skills:** `add-analytics`
...
- Track events, script injection config.
