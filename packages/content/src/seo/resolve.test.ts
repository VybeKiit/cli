...
import { createSeoFromEnv, resolveSeoService } from '@vybekiit/content/seo/resolve';
...
describe('createSeoFromEnv metadata', () => {
  it('builds metadata with canonical URL', () => {
    const seo = createSeoFromEnv(env);
...
describe('createSeoFromEnv content helpers', () => {
