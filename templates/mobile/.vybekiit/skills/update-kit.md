...
> **version bumps, not git merges** — the builder's own files are never touched. The passing test
> suite is what makes a bump safe.
...
5. **Try the app for real on the phone.** Start it and click through the main things (sign-in, a
