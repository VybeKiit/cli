---
name: onboarding
description: take the builder from "I just bought this" to **their app running on their own phone** in. Use when the builder says something like: set up my app; let's start; get me going; just bought.
metadata:
