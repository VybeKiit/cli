---
name: setup-payments
description: the builder can take real money in the app. By the end, a test purchase succeeds. Use when the builder says something like: add payments; take money; sell something; charge people.
metadata:
