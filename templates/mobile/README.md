...
Built with **VybeKiit**. This is your phone app starting point. You do not need to read code to use it. Tell your AI helper what you want to build.
...
```sh
npx vybekiit setup
npx vybekiit create app --mobile
```
...
Start with first-time setup until I can see my app running on my phone.
```
...
Your helper takes it from there. It reads its instructions, walks you through the few steps only you can do (one at a time, in plain language), and gets your app on your phone.

## Things you can ask for

- **"Set up my app"**: first-time setup, ends with your app running on your phone.
...
- **"Publish my app"**: ship the latest version to the app stores.
