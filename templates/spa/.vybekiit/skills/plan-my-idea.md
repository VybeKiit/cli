...
- They describe something big and vague ("a marketplace", "like Airbnb") without specifics.
...
2. **Walk the decision tree — one question at a time.**
   ...
   - When they use a fuzzy word ("account", "user", "order"), sharpen it: *"Do you mean someone who
     pays, or someone who just logs in?"*
...
4. **Close with a plain summary.**
   ...
   `goal-index.md` (payments, sign-in, put it online, build the page, etc.).
