...
> `.vybekiit/platform-skills/` (`deploy-cloudflare-vybekiit.md` or `deploy-vercel-vybekiit.md`).
> Pick the host from their settings; don't make the builder choose or hear the host's name
> (unless they ask).
...
4. **Want their own web address?** If they'd like to use their own domain instead of the temporary
