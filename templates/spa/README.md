...
Built with **VybeKiit**. This is an app that runs in the browser as one smooth place (screens, dashboard, and tools in one flow). You do not need to read code to use it. Tell your AI helper what you want to build.
...
Start with first-time setup until I can see my app running (the preview on my computer or live).
```
...
Your helper takes it from there. It reads its instructions, walks you through the few steps only you can do (one at a time, in plain language), and gets your app running.

## Things you can ask for

- **"Set up my app"**: first-time setup, ends with your app on the preview on your computer or live.
- **"Add payments"**: start taking money.
- **"Add sign-in and save data"**: accounts and a place where your app remembers things.
