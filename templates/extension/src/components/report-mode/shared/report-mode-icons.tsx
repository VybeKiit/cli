...
/**
 * Render the six-dot grip for dragging the dock.
 *
 * @param props - SVG props for the icon.
 * @returns The drag grip icon.
 * @example
 * <ReportDragIcon />
 */
export const ReportDragIcon = ({ className, ...props }: IconProps) => (
  <svg
    aria-hidden="true"
...
/**
 * Render the inspect target icon.
 *
 * @param props - SVG props plus active animation state.
 * @returns The target icon.
 * @example
 * <ReportTargetIcon active={true} />
 */
export const ReportTargetIcon = ({
  active = false,
  className,
  ...props
}: ReportTargetIconProps) => (
  <svg
    aria-hidden="true"
    className={cn(
 ...
 * <ReportPinIcon />
 */
export const ReportPinIcon = ({ className, ...props }: IconProps) => (
  <svg
    aria-hidden="true"
...
/**
 * Render the chat handoff icon.
 *
 * @param props - SVG props plus the handoff target.
 * @returns The chat handoff icon.
 * @example
 * <ReportChatHandoffIcon target="new-chat" />
 */
export const ReportChatHandoffIcon = ({ target, className, ...props }: ReportChatIconProps) => {
...
/**
 * Render a corner anchor icon.
 *
 * @param props - SVG props plus corner and beam state.
 * @returns The corner anchor icon.
 * @example
 * <CornerAnchorIcon corner="bottom-right" />
 */
export const CornerAnchorIcon = ({
  beaming = false,
  corner,
  className,
  ...props
 ...
 */
export const ReportBrandChevronIcon = ({
  className,
  direction,
  ...props
...
/**
 * Render the note submit icon.
 *
 * @param props - SVG props for the icon.
 * @returns The send icon.
 * @example
 * <ReportSendIcon />
 */
export const ReportSendIcon = ({ className, ...props }: IconProps) => (
  <svg
    aria-hidden="true"
...
/**
 * Render the note cancel icon.
 *
 * @param props - SVG props for the icon.
 * @returns The cancel icon.
 * @example
 * <ReportCancelIcon />
 */
export const ReportCancelIcon = ({ className, ...props }: IconProps) => (
  <svg
    aria-hidden="true"
 ...
 * <ReportCopyIcon />
 */
export const ReportCopyIcon = ({ className, ...props }: IconProps) => (
  <svg
    aria-hidden="true"
 ...
 *
 * @param props - Span props for the mark.
 * @returns The masked brand mark.
 * @example
 * <ReportVybeMarkIcon />
 */
export const ReportVybeMarkIcon = ({ className, style, ...props }: BrandIconProps) => {
