---
name: check-safety
description: confirm the extension and its backend connection are ready before store publish. Use when the builder says something like: lock down; make it safe; protect from abuse; am i ready to ship; is my app safe; did we cover security.
metadata:
