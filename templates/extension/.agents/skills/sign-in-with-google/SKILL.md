...
description: people sign in **or** sign up with Google from the extension — one tap. Use when the builder says something like: sign in with google; continue with google.
metadata:
