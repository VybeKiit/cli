...
| "publish my extension", "Chrome Web Store", "extension store", "list my extension" | `skills/publish-extension.md` |
| (agent-only) feature needs camera, tabs, storage, notifications, etc. | `skills/configure-capabilities.md` |
