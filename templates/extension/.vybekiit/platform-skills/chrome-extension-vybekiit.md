...
4. Store publish: `@vybekiit/extension-publish` Playwright verbs + listing source in `cws-listing.ts`
5. Follow `packages/extension-publish/CONTEXT.md` for CWS vocabulary
