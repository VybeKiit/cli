        ...
        <div className="@max-xl:-mx-6 not-dark:bg-linear-to-b not-dark:via-muted relative flex items-center overflow-hidden rounded-3xl *:w-full">
          <div
            ...
            className={cn(
              ...
              feature === 'seamless-integrations' && '*:bg-linear-to-t grid-cols-1 grid-rows-12',
...
const IntegrationsIllustration = () => (
  <div aria-hidden={true} className="**:fill-foreground flex h-44 flex-col justify-between pt-8">
...
const RealTimeIllustration = () => (
  <div aria-hidden={true} className="relative h-44 translate-y-6">
...
const EnterpriseIllustration = () => (
  <div aria-hidden={true} className="relative flex size-44 items-center justify-center">
