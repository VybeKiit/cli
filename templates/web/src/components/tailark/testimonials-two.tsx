        ...
        <div className="@container mx-auto w-full max-w-5xl px-6">
          <div className="mb-12">
            ...
            <p className="text-muted-foreground my-4 text-balance text-lg">
              Discover why our clients love working with us. Read their testimonials about our
              dedication to excellence, innovative solutions, and exceptional customer service.
            </p>
          </div>
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index}>
                ...
                <div className="mt-4 flex items-center gap-2">
                  ...
                  <span aria-hidden={true} className="bg-foreground/25 size-1 rounded-full" />
