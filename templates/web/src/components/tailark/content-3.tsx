        ...
        <div className="@xl:grid-cols-3 mt-12 grid grid-cols-2 gap-6 text-sm">
          <div className="space-y-3 border-t pt-6">
            ...
            <p className="text-muted-foreground leading-5">
              <span className="text-foreground font-medium">Generate Ideas</span> Spark creativity
              with AI-powered content suggestions and inspiration.
            </p>
          </div>
          ...
          <div className="space-y-3 border-t pt-6">
            ...
            <p className="text-muted-foreground leading-5">
              <span className="text-foreground font-medium">Improve Writing</span> Enhance your text
          ...
          <div className="space-y-3 border-t pt-6">
            ...
            <p className="text-muted-foreground leading-5">
              <span className="text-foreground font-medium">Design Layouts</span> Create visually
              appealing layouts that capture your audience's attention.
            </p>
          </div>
        </div>
      </div>
