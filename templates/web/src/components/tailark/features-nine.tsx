        ...
        <div className="mx-auto w-full max-w-2xl px-6 lg:px-0">
          ...
          <div className="mt-16 space-y-12">
            <div className="grid items-center gap-6 sm:grid-cols-5">
              <Card variant="soft" className="p-6 sm:col-span-2">
                <MeetingIllustration />
              </Card>
            ...
            <div className="grid items-center gap-6 sm:grid-cols-5">
              <Card variant="soft" className="overflow-hidden p-6 sm:col-span-2 sm:overflow-clip">
...
const MeetingIllustration = () => (
  <Card aria-hidden={true} className="aspect-video p-4">
