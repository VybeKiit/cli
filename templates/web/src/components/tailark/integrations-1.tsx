    ...
    <section className="bg-background @container py-24">
      <div className="mx-auto max-w-2xl px-6">
        ...
        <div className="mx-auto mt-12 max-w-md text-balance text-center">
          ...
          <Button variant="secondary" size="sm" asChild={true} className="gap-1 pr-1.5">
            <Link href="#">
              Learn more
              <ChevronRight />
            </Link>
...
const IntegrationsIllustration = () => (
  ...
  >
    ...
    <div className="@lg:px-24 relative flex h-10 items-center justify-between px-12">
      <div className="bg-border absolute inset-0 my-auto h-px" />
      <div className="bg-linear-to-r mask-l-from-15% mask-l-to-40% mask-r-from-75% mask-r-to-75% from-primary absolute inset-0 my-auto h-px w-1/2 via-amber-500 to-pink-400" />
      <div className="bg-linear-to-r mask-r-from-15% mask-r-to-40% mask-l-from-75% mask-l-to-75% absolute inset-0 my-auto ml-auto h-px w-1/2 from-indigo-500 via-emerald-500 to-blue-400" />
