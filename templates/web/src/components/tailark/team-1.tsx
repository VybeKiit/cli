        ...
        <div className="mt-12 grid gap-12 text-sm">
          {members.map((member, index) => (
            <div key={index} className="relative grid grid-cols-[auto_1fr] gap-4">
              <div aria-hidden={true} className="max-h-26 absolute -inset-x-6 inset-y-1 border-y" />
              <div aria-hidden={true} className="w-26 absolute -inset-y-6 inset-x-1 border-x" />
