  ...
  return (
    <section className="bg-background @container py-24">
      <div className="mx-auto max-w-2xl px-6">
        <Card variant="outline" className="@xl:grid-cols-2 grid gap-8 p-6 md:p-8">
          <div>
            <h2 className="text-balance font-serif text-3xl font-medium">
              Transform Your Workflow
            </h2>
            <p className="text-muted-foreground mt-3 text-balance">
              Experience the power of seamless integrations and watch your productivity soar.
            </p>
          ...
          <div className="bg-muted/50 flex flex-col justify-center rounded-xl border p-6">
            ...
            <Button asChild={true} className="mt-6 gap-2">
              <Link href="#link">
                Get Started Free
