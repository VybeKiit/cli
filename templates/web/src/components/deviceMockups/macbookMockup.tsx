...
/**
 * Render laptop chrome around marketing previews and gallery embeds.
 *
 * @param props - Optional preview content plus native div props.
 * @returns A responsive laptop mockup frame.
 * @example
 * <MacbookMockup><img alt="" src="/preview.png" /></MacbookMockup>
 */
