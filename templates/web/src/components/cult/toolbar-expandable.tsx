...
const DynamicToolbarExpandable = React.memo<DynamicToolbarExpandableProps>(
  function DynamicToolbarExpandable({
    ...
    const active = controlledActiveStep === undefined ? internalActive : controlledActiveStep;
    const isOpen = controlledExpanded === undefined ? internalIsOpen : controlledExpanded;
