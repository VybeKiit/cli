    ...
    <div className="dark:bg-stone-950 flex flex-col items-center gap-12 rounded-md px-4 py-6 md:px-0">
      ...
      <div className="flex w-full max-w-5xl flex-col gap-10">
        ...
        <DemoSection title="Panels and frames">
          <BandTile label="Stepped inset frame" tall={true}>
            <SteppedInsetFrameSvg />
          </BandTile>
          <BandTile label="Angled corner panel" tall={true}>
            <AngledCornerPanelSvg />
          </BandTile>
          <BandTile label="Dual side notch frame" tall={true}>
            <DualSideNotchFrameSvg />
          </BandTile>
          <BandTile label="Tall angled hero" tall={true}>
            <TallAngledHeroPanelSvg />
          </BandTile>
        </DemoSection>
