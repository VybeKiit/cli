  ...
  return (
    <div className="space-y-8 p-4 ">
      ...
      <div>
        ...
        <div>
          <NeumorphButton fullWidth={true}>Full Width</NeumorphButton>
        </div>
      </div>
      <div>
        <h2 className="text-lg font-semibold mb-2">Disabled Buttons</h2>
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          <NeumorphButton disabled={true}>Disabled Default</NeumorphButton>
          <NeumorphButton intent="primary" disabled={true}>
            Disabled Primary
          </NeumorphButton>
          <NeumorphButton intent="secondary" disabled={true}>
            Disabled Secondary
          </NeumorphButton>
          <NeumorphButton intent="danger" disabled={true}>
            Disabled Danger
          </NeumorphButton>
        </div>
      </div>
