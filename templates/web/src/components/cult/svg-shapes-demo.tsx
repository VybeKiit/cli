    ...
    <div className="dark:bg-stone-950 flex flex-col items-center gap-12 rounded-md px-4 py-6 md:px-0">
      ...
      <div className="flex w-full max-w-5xl flex-col gap-10">
        ...
        <DemoSection title="Sacred geometry">
          <ShapeTile label="Vesica piscis" tall={true}>
            <VesicaPiscisSvg />
          </ShapeTile>
          <ShapeTile label="Seed of life" tall={true}>
            <SeedOfLifeSvg />
          </ShapeTile>
          <ShapeTile label="Flower of life" tall={true}>
            <FlowerOfLifeSvg />
          </ShapeTile>
          <ShapeTile label="Metatron’s cube" tall={true}>
            <MetatronsCubeSvg />
          </ShapeTile>
          <ShapeTile label="Sri Yantra" tall={true}>
            <SriYantraSvg />
          </ShapeTile>
          <ShapeTile label="Golden spiral" tall={true}>
            <GoldenSpiralSvg />
          </ShapeTile>
          <ShapeTile label="Torus tube" tall={true}>
            <TorusTubeSvg />
          </ShapeTile>
        </DemoSection>
