...
const data: SankeyData = {
  ...
  links: [
    { source: 0, target: 3, value: 450_000 },
    { source: 1, target: 3, value: 320_000 },
    { source: 2, target: 3, value: 180_000 },
    { source: 3, target: 4, value: 185_000 },
    { source: 3, target: 5, value: 142_000 },
    { source: 3, target: 6, value: 198_000 },
    { source: 3, target: 7, value: 285_000 },
    { source: 3, target: 8, value: 140_000 },
  ],
};
  ...
  return (
    <EvilSankeyChart className="h-full w-full p-4" data={data} config={chartConfig}>
      <Node isClickable={true}>
        <NodeLabel position="outside" showValues={true} />
      </Node>
