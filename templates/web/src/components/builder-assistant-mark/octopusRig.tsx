...
function rigVars(vars: Record<string, string | number>): CSSProperties {
  return vars as CSSProperties;
}

function RigFrameGroup({ frame, index }: { readonly frame: RigFrame; readonly index: number }) {
  return (
    <g
 ...
 */
export function ClaudeOctopusRig({
  className,
  pose,
}: {
...
/** Proof/hero wrapper — the celebration jump (frames l001–l005 + confetti). */
export function ClaudeOctopusJump() {
  return <ClaudeOctopusRig pose="celebrating" />;
}
