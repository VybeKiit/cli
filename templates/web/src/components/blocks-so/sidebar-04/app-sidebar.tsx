...
const data = {
  ...
  mails: [
    ...
    },
    {
      ...
      date: 'Sep 09',
      teaser: "Event 'Design sync' moved to 3:30 PM. Meet link updated in the invite.",
    },
    {
      name: 'HN Daily',
    ...
    <div className="flex">
      ...
      >
        <SidebarHeader>
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton size="lg" asChild={true} className="md:h-8 md:p-0">
                <a href="#">
        ...
        <SidebarContent>
          ...
          <SidebarGroup>
            <SidebarGroupLabel className="px-1.5 md:px-0 text-xs">Labels</SidebarGroupLabel>
            <SidebarGroupContent className="px-1.5 md:px-0">
              <SidebarMenu>
                {data.labels.map((label) => (
                  <SidebarMenuItem key={label.title}>
                    <SidebarMenuButton asChild={true} className="px-2.5 md:px-2">
      ...
      <Sidebar collapsible="none" className="hidden flex-1 border-r md:flex min-w-96">
