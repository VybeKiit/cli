          ...
          <div className="sm:max-w-3xl md:col-span-2">
            <fieldset>
              ...
              <div className="mt-2">
                <div className="flex items-center gap-x-3 py-1">
                  <Checkbox id="team-requests" name="team-requests" defaultChecked={true} />
            ...
            <fieldset className="mt-6">
              ...
              <div className="mt-2">
                ...
                <div className="flex items-center gap-x-3 py-1">
                  <Checkbox id="query-caching" name="query-caching" defaultChecked={true} />
                  <FieldLabel htmlFor="query-caching" className="font-normal">
                    Query caching
                  </FieldLabel>
                </div>
                <div className="flex items-center gap-x-3 py-1">
                  <Checkbox id="storage" name="storage" defaultChecked={true} />
