...
const steps = [
  {
    ...
    description: "Choose a name, pick a subdomain, and configure your store's basic settings.",
  },
  {
    id: '2.',
    title: 'Add your products',
    description: 'Upload your catalog with photos, pricing, and inventory details.',
  },
  {
    id: '3.',
    title: 'Set up payments',
    description: 'Connect Stripe or PayPal to start accepting orders from customers.',
  },
  {
    id: '4.',
      ...
      <div className="sm:mx-auto sm:max-w-lg">
        ...
        <div className="mt-6 rounded-lg bg-muted p-4">
          ...
          <p className="mt-1 text-muted-foreground text-sm">
            ...
            <a className="font-medium text-primary" href="mailto:help@example.com">
              help@example.com
            </a>
            .
          </p>
