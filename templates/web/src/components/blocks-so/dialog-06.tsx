      ...
      <DialogContent className="p-0 sm:max-w-lg">
        <DialogHeader className="px-6 pt-4">
          ...
          <DialogDescription className="text-pretty mt-2 text-sm leading-6 text-muted-foreground">
            Workspaces are shared environments where teams can connect to data sources, run queries
            and create reports.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="border-t bg-muted rounded-b-md px-6 py-4">
            <div className="flex items-start space-x-3">
              <div className="mt-1 pt-0.5">
                <Switch id="enable-private-workspace" name="enable-private-workspace" />
              </div>
              <div>
                <Label htmlFor="enable-private-workspace" className="text-sm font-medium">
