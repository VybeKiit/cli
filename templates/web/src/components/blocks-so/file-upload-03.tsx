      ...
      <Card className="relative p-4 shadow-none">
        ...
        <CardContent className="flex items-center space-x-3 p-0">
          ...
          <div>
            ...
            <p className="text-pretty mt-0.5 text-sm text-muted-foreground">{file.size} bytes</p>
          </div>
        </CardContent>
      </Card>
    </li>
          ...
          <form action="#" method="post">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-6">
              ...
              <div className="col-span-full sm:col-span-3">
                ...
                <Select defaultValue="private" disabled={true}>
                  <SelectTrigger id="visibility" name="visibility" className="mt-2 w-full">
