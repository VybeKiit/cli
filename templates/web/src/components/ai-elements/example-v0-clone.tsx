...
const SuggestionItem = memo(({ text, onSuggestionClick }: SuggestionItemProps) => {
...
export default function Home() {
  ...
  const handleSendMessage = useCallback(
    async (promptMessage: PromptInputMessage) => {
      ...
      setChatHistory((prev) => [...prev, { content: userMessage, id: nanoid(), type: 'user' }]);
    ...
    <div className="flex size-full divide-x">
      ...
      <div className="flex flex-1 flex-col">
        <WebPreview className="rounded-none border-0">
          <WebPreviewNavigation>
            <WebPreviewUrl placeholder="Your app here..." value={currentChat?.demo} />
          </WebPreviewNavigation>
