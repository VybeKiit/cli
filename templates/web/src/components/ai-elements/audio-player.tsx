...
import { ButtonGroup, ButtonGroupText } from '@vybekiit/ui/button-group';
...
export const AudioPlayerPlayButton = ({ className, ...props }: AudioPlayerPlayButtonProps) => (
  <Button asChild={true} size="icon-sm" variant="outline">
    <MediaPlayButton
...
export const AudioPlayerTimeDisplay = ({ className, ...props }: AudioPlayerTimeDisplayProps) => (
  <ButtonGroupText asChild={true} className="bg-transparent">
    <MediaTimeDisplay
