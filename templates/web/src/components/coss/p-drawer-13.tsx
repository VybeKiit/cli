...
export default function Particle() {
  ...
  if (isMobile) {
    return (
      <Drawer>
        <DrawerTrigger
          render={<Button aria-label={TRIGGER_ARIA_LABEL} size="icon" variant="outline" />}
        >
        ...
        <DrawerPopup showBar={true}>
          <DrawerPanel>
            <DrawerMenu>
              ...
              <DrawerMenuCheckboxItem disabled={true}>Enhanced Audio</DrawerMenuCheckboxItem>
              <DrawerMenuSeparator />
              <DrawerMenuGroup>
  ...
  return (
    <Menu>
      ...
      <MenuPopup>
        ...
        <MenuCheckboxItem disabled={true}>Enhanced Audio</MenuCheckboxItem>
        <MenuSeparator />
        <MenuGroup>
