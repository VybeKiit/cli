...
Your helper takes it from there. It reads its instructions, walks you through the few steps only you can do (one at a time, in plain language), and gets your app online.

## Things you can ask for

- **"Set up my app"**: first-time setup, ends with your app online or on the preview on your computer.
